...
server_url = "192.168.1.19"  # Adresse IP du serveur
server_port = 443  # Port HTTPS

# Certificats et clé
ca_cert_path = "./CA/CAPV.crt"  # Chemin vers le certificat CA
client_cert_path = "./device/devicePV.crt"  # Chemin vers le certificat client
client_key_path = "./device/devicePV.key"  # Chemin vers la clé privée du client
